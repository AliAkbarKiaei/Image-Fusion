function weightedFusionDel = fn_fusion_GV(U1, ROI_BW, ROI_U2, pos, weight)
...
%% fusion method
Gx_ROI_U = weight*Gx_ROI_U1 + (1-weight)*Gx_ROI_U2;
Gy_ROI_U = weight*Gy_ROI_U1 + (1-weight)*Gy_ROI_U2;
...
mseMax=1e-2;
MSE=mseMax+1;    ROI_temp=(weight*ROI_U1 + (1-weight)*ROI_U2)/2; iteration=1;
