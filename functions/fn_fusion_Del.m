function waterize_Del = fn_fusion_Del(U1, ROI_BW, ROI_U2, pos, waterizedFactor)
...
%% fusion method
Gx_ROI_U2 = waterizedFactor*Gx_ROI_U2 + (1-waterizedFactor)*Gx_ROI_U1;
Gy_ROI_U2 = waterizedFactor*Gy_ROI_U2 + (1-waterizedFactor)*Gy_ROI_U1;
...
while ((MSE>mseMax) && (iteration<257))
    for r=3:rROI-2
        for c=3:cROI-2
            if ROI_BW(r,c)==1
...
figure, imshow(uint8(waterize_Del)); title('waterize: Del edition');
